                        ...
                        <div className="container mt-70">
                            <div className="row">
                                ...
                                <div className="col-lg-10 col-sm-10 col-12 text-center">
                                    <h2 className="text-heading-1 color-gray-900 mb-10">Una Nube Blog</h2>
                                    <p className="text-heading-6 color-gray-600 mt-20"> Una Nube Blog es tu ventana a un mundo de conocimiento sobre tecnología en la nube. <br className="d-lg-block d-none" />Exploramos sus beneficios, la cultura en torno a ella, tecnologías nativas de la nube y mucha información para mantenerte actualizado en este emocionante ámbito. ¡Bienvenido!</p>
                                </div>
                                <div className="col-lg-1 col-sm-1 col-12" />
                            </div>
                        </div>
